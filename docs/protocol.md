        # Tda Ma: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/tda-ma.git

        ## Objective

        TDA-MA applies topological data analysis to meta-analytic datasets, identifying persistent homological features in evidence structures that may indicate systematic bias patterns.
        ...
        - Code: https://github.com/mahmood726-cyber/tda-ma.git
